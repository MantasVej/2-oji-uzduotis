...
void Galutinis(deque<Mokinys>& temp, char galutinis)
{
    for(auto&s : temp){
...
void Isvedimas(deque<Mokinys>& mas, string failas) {
...
void Rusiavimas(deque<Mokinys>& mas, int n)
{
